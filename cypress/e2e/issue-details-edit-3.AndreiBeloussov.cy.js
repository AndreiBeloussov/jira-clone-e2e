...
describe('Issue details editing', () => {
  ...
  it('Should update title, description successfully', () => {
    ...
    getIssueDetailsModal().within(() => {
      IssueDetailsModal.issueTitleDescriptionUpdate();
  ...
  // Workshop 17
  // Task 3
  // Add new test to test file, Invoke text value of reporter name and check that it 
  // has only characters in it (no numbers, no special characters).


  it.only('Regex test', () => {
    getIssueDetailsModal();
    IssueDetailsModal.RegexReporter();
